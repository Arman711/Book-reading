...
mixin _$UserEvent {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(AppUser user) createUser,
    required TResult Function(String id) deleteUser,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(AppUser user)? createUser,
...
class _$CreateUserImpl implements _CreateUser {
  const _$CreateUserImpl({required this.user});
...
abstract class _CreateUser implements UserEvent {
  const factory _CreateUser({required final AppUser user}) = _$CreateUserImpl;
